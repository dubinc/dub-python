...
<!-- UsageSnippet language="python" operationID="deactivatePartner" method="post" path="/partners/deactivate" -->
```python
from dub import Dub
...
**[operations.DeactivatePartnerResponseBody](../../models/operations/deactivatepartnerresponsebody.md)**
