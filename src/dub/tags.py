...
class Tags(BaseSDK):
    ...
    def update(
        ...
        request = operations.UpdateTagRequest(
            id=id,
            request_body=utils.unmarshal(request_body, operations.UpdateTagRequestBody) if not isinstance(request_body, BaseModel) and request_body is not None else request_body,
        )
