...
class SaleCreatedEventDataLinkTypedDict(TypedDict):
    id: str
...
class SaleCreatedEventDataLink(BaseModel):
    id: str
    r"""The unique ID of the short link."""
...
class SaleCreatedEventType(str, Enum):
    PERCENTAGE = "percentage"
    FLAT = "flat"


class SaleCreatedEventInterval(str, Enum):
    MONTH = "month"
    YEAR = "year"


class SaleCreatedEventDiscountTypedDict(TypedDict):
    id: str
    ...
    interval: Nullable[SaleCreatedEventInterval]


class SaleCreatedEventDiscount(BaseModel):
    id: str
...
class SaleCreatedEventCustomerTypedDict(TypedDict):
    ...
    link: NotRequired[Nullable[SaleCreatedEventDataLinkTypedDict]]
    partner: NotRequired[Nullable[SaleCreatedEventPartnerTypedDict]]
    discount: NotRequired[Nullable[SaleCreatedEventDiscountTypedDict]]
...
class SaleCreatedEventCustomer(BaseModel):
    ...
    link: OptionalNullable[SaleCreatedEventDataLink] = UNSET

    partner: OptionalNullable[SaleCreatedEventPartner] = UNSET

    discount: OptionalNullable[SaleCreatedEventDiscount] = UNSET
