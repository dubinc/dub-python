...
class LinkSchema(BaseModel):
    ...
    geo: Nullable[Geo]
    r"""Geo targeting information for the short link in JSON format `{[COUNTRY]: https://example.com }`. Learn more: https://d.to/geo"""
    tag_id: Annotated[Nullable[str], pydantic.Field(deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible.", alias="tagId")]
    r"""The unique ID of the tag assigned to the short link. This field is deprecated – use `tags` instead."""
    ...
    r"""The date and time when the short link was last updated."""
    project_id: Annotated[str, pydantic.Field(deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible.", alias="projectId")]
    r"""The project ID of the short link. This field is deprecated – use `workspaceId` instead."""
