...
class LeadsCountriesCountry(str, Enum):
...
class LeadsCountries:
    country: LeadsCountriesCountry = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('country') }})
    r"""The 2-letter country code: https://d.to/geo"""
