...
class LinkClickedEventEvent(str, Enum):
    LINK_CLICKED = "link.clicked"


class LinkClickedEventClickTypedDict(TypedDict):
    id: str
    timestamp: str
    url: str
    country: str
...
class LinkClickedEventGeo(BaseModel):
    r"""Geo targeting information for the short link in JSON format `{[COUNTRY]: https://example.com }`. Learn more: https://d.to/geo"""
...
class LinkClickedEventTestVariantsTypedDict(TypedDict):
    url: str
    percentage: float


class LinkClickedEventTestVariants(BaseModel):
    url: str

    percentage: float


class LinkClickedEventLinkTypedDict(TypedDict):
    id: str
...
class LinkClickedEventLink(BaseModel):
    ...
    geo: Nullable[LinkClickedEventGeo]
    r"""Geo targeting information for the short link in JSON format `{[COUNTRY]: https://example.com }`. Learn more: https://d.to/geo"""
...
class DataTypedDict(TypedDict):
    click: LinkClickedEventClickTypedDict
    link: LinkClickedEventLinkTypedDict
...
class LinkClickedEventTypedDict(TypedDict):
    r"""Triggered when a link is clicked."""
