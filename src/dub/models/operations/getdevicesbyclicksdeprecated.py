...
class GetDevicesByClicksDeprecatedGlobals:
...
class GetDevicesByClicksDeprecatedQueryParamInterval(str, Enum):
...
class GetDevicesByClicksDeprecatedRequest:
    ...
    interval: Optional[GetDevicesByClicksDeprecatedQueryParamInterval] = dataclasses.field(default=GetDevicesByClicksDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetDevicesByClicksDeprecatedResponseBody:
...
@dataclasses.dataclass
class GetDevicesByClicksDeprecatedResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetDevicesByClicksDeprecatedResponseBody]] = dataclasses.field(default=None)
