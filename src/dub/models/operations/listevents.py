...
from dub.models.components import clickevent as components_clickevent, continentcode as components_continentcode, countrycode as components_countrycode, leadevent as components_leadevent, saleevent as components_saleevent
...
class ListEventsRequest(BaseModel):
    event: Annotated[Optional[QueryParamEvent], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = QueryParamEvent.CLICKS
    r"""The type of event to retrieve analytics for. Defaults to 'clicks'."""
    ...
    r"""This is the ID of the link in the your database. Must be prefixed with 'ext_' when passed as a query parameter."""
    interval: Annotated[Optional[QueryParamInterval], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
    ...
    r"""Filter for root domains. If true, filter for domains only. If false, filter for links only. If undefined, return both."""
    page: Annotated[Optional[float], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = 0
    limit: Annotated[Optional[float], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = 100
    order: Annotated[Optional[Order], FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = Order.DESC
    sort_by: Annotated[Optional[SortBy], pydantic.Field(alias="sortBy"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = SortBy.TIMESTAMP
    

ListEventsResponseBodyTypedDict = Union[List[components_clickevent.ClickEventTypedDict], List[components_leadevent.LeadEventTypedDict], List[components_saleevent.SaleEventTypedDict]]
r"""A list of events"""


ListEventsResponseBody = Union[List[components_clickevent.ClickEvent], List[components_leadevent.LeadEvent], List[components_saleevent.SaleEvent]]
r"""A list of events"""
