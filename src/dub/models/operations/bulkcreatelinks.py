...
BulkCreateLinksTagIdsTypedDict = Union[str, List[str]]
...
BulkCreateLinksTagNamesTypedDict = Union[str, List[str]]
...
class RequestBody(BaseModel):
    ...
    r"""The unique ID of the tag assigned to the short link. This field is deprecated – use `tagIds` instead."""
    tag_ids: Annotated[Optional[BulkCreateLinksTagIds], pydantic.Field(alias="tagIds")] = None
    r"""The unique IDs of the tags assigned to the short link."""
    tag_names: Annotated[Optional[BulkCreateLinksTagNames], pydantic.Field(alias="tagNames")] = None
    r"""The unique name of the tags assigned to the short link (case insensitive)."""
    ...
    def serialize_model(self, handler):
        optional_fields = ["domain", "key", "externalId", "prefix", "trackConversion", "archived", "publicStats", "tagId", "tagIds", "tagNames", "comments", "expiresAt", "expiredUrl", "password", "proxy", "title", "description", "image", "video", "rewrite", "ios", "android", "geo", "doIndex", "utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"]
