...
class CreatePartnerNetworkStatus(str, Enum):
...
class CreatePartnerTagsTypedDict(TypedDict):
    id: str
    name: str


class CreatePartnerTags(BaseModel):
    id: str
...
class CreatePartnerResponseBodyTypedDict(TypedDict):
    ...
    network_status: CreatePartnerNetworkStatus
    r"""The partner's network status on Dub."""
...
class CreatePartnerResponseBody(BaseModel):
    ...
    network_status: Annotated[
        CreatePartnerNetworkStatus, pydantic.Field(alias="networkStatus")
    ]
    r"""The partner's network status on Dub."""
    ...
    tags: Optional[List[CreatePartnerTags]] = None
    r"""The tags associated with the partner."""

    total_clicks: Annotated[Optional[float], pydantic.Field(alias="totalClicks")] = 0.0
    r"""The total number of clicks on the partner's links"""

    total_leads: Annotated[Optional[float], pydantic.Field(alias="totalLeads")] = 0.0
    r"""The total number of leads generated by the partner's links"""
    ...
    total_sales: Annotated[Optional[float], pydantic.Field(alias="totalSales")] = 0.0
    r"""The total number of sales generated by the partner's links (includes recurring sales)"""
    ...
    net_revenue: Annotated[Optional[float], pydantic.Field(alias="netRevenue")] = 0.0
    r"""Net revenue after commissions (`Total Revenue - Total Commissions`)"""
