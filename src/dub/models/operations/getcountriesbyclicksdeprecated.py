...
class GetCountriesByClicksDeprecatedGlobals:
...
class GetCountriesByClicksDeprecatedQueryParamInterval(str, Enum):
...
class GetCountriesByClicksDeprecatedRequest:
    ...
    interval: Optional[GetCountriesByClicksDeprecatedQueryParamInterval] = dataclasses.field(default=GetCountriesByClicksDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
