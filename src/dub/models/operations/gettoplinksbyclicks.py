...
class GetTopLinksByClicksGlobals:
...
class GetTopLinksByClicksQueryParamInterval(str, Enum):
...
class GetTopLinksByClicksRequest:
    ...
    interval: Optional[GetTopLinksByClicksQueryParamInterval] = dataclasses.field(default=GetTopLinksByClicksQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetTopLinksByClicksResponseBody:
...
@dataclasses.dataclass
class GetTopLinksByClicksResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetTopLinksByClicksResponseBody]] = dataclasses.field(default=None)
