...
class UpdateLinkGlobalsTypedDict(TypedDict):
    workspace_id: NotRequired[str]
    

class UpdateLinkGlobals(BaseModel):
...
class UpdateLinkRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["url", "domain", "key", "externalId", "prefix", "trackConversion", "archived", "publicStats", "tagId", "tagIds", "tagNames", "comments", "expiresAt", "expiredUrl", "password", "proxy", "title", "description", "image", "rewrite", "ios", "android", "geo", "doIndex"]
