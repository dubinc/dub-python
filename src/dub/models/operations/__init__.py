...
_dynamic_imports: dict[str, str] = {
    ...
    "IndustryInterests": ".listpayouts",
    "InvoiceSettings": ".listpayouts",
    "InvoiceSettingsTypedDict": ".listpayouts",
    ...
    "MonthlyTraffic": ".listpayouts",
    "PreferredEarningStructures": ".listpayouts",
    "ProfileType": ".listpayouts",
    "SalesChannels": ".listpayouts",
    "User": ".listpayouts",
