...
class TrackSaleClickTypedDict(TypedDict):
    url: str
    ip: str
    continent: str
    country: str
...
class TrackSaleClick(BaseModel):
    url: str
    ip: str
    continent: str
    country: str
...
class TrackSaleGeoTypedDict(TypedDict):
...
class TrackSaleLinkTypedDict(TypedDict):
    id: str
    ...
    geo: Nullable[TrackSaleGeoTypedDict]
    r"""Geo targeting information for the short link in JSON format `{[COUNTRY]: https://example.com }`. Learn more: https://d.to/geo"""
...
class TrackSaleLink(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = ["externalId", "expiresAt", "expiredUrl", "password", "title", "description", "image", "video", "ios", "android", "geo", "comments", "utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content", "lastClicked"]
        null_default_fields = []
...
class TrackSaleResponseBodyTypedDict(TypedDict):
    ...
    sale: SaleTypedDict
    click: TrackSaleClickTypedDict
    link: TrackSaleLinkTypedDict
