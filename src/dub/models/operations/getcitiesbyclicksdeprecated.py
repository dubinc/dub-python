...
class GetCitiesByClicksDeprecatedGlobals:
...
class GetCitiesByClicksDeprecatedQueryParamInterval(str, Enum):
...
class GetCitiesByClicksDeprecatedRequest:
    ...
    interval: Optional[GetCitiesByClicksDeprecatedQueryParamInterval] = dataclasses.field(default=GetCitiesByClicksDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
