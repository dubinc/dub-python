...
class RetrievePartnerLinksRequestTypedDict(TypedDict):
...
class RetrievePartnerLinksRequest(BaseModel):
...
class RetrievePartnerLinksResponseBodyTypedDict(TypedDict):
    id: str
...
class RetrievePartnerLinksResponseBody(BaseModel):
    id: str
    r"""The unique ID of the short link."""
...
try:
    RetrievePartnerLinksResponseBody.model_rebuild()
except NameError:
    pass
