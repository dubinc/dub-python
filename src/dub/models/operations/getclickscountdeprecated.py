...
class GetClicksCountDeprecatedGlobals:
...
class GetClicksCountDeprecatedQueryParamInterval(str, Enum):
...
class GetClicksCountDeprecatedRequest:
    ...
    interval: Optional[GetClicksCountDeprecatedQueryParamInterval] = dataclasses.field(default=GetClicksCountDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetClicksCountDeprecatedResponse:
