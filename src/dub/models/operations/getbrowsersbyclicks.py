...
class GetBrowsersByClicksGlobals:
...
class GetBrowsersByClicksQueryParamInterval(str, Enum):
...
class GetBrowsersByClicksRequest:
    ...
    interval: Optional[GetBrowsersByClicksQueryParamInterval] = dataclasses.field(default=GetBrowsersByClicksQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetBrowsersByClicksResponseBody:
...
@dataclasses.dataclass
class GetBrowsersByClicksResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetBrowsersByClicksResponseBody]] = dataclasses.field(default=None)
