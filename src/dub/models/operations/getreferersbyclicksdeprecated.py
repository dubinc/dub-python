...
class GetReferersByClicksDeprecatedGlobals:
...
class GetReferersByClicksDeprecatedQueryParamInterval(str, Enum):
...
class GetReferersByClicksDeprecatedRequest:
    ...
    interval: Optional[GetReferersByClicksDeprecatedQueryParamInterval] = dataclasses.field(default=GetReferersByClicksDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetReferersByClicksDeprecatedResponseBody:
...
@dataclasses.dataclass
class GetReferersByClicksDeprecatedResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetReferersByClicksDeprecatedResponseBody]] = dataclasses.field(default=None)
