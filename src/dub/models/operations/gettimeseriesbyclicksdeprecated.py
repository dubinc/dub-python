...
class GetTimeseriesByClicksDeprecatedGlobals:
...
class GetTimeseriesByClicksDeprecatedQueryParamInterval(str, Enum):
...
class GetTimeseriesByClicksDeprecatedRequest:
    ...
    interval: Optional[GetTimeseriesByClicksDeprecatedQueryParamInterval] = dataclasses.field(default=GetTimeseriesByClicksDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetTimeseriesByClicksDeprecatedResponseBody:
...
@dataclasses.dataclass
class GetTimeseriesByClicksDeprecatedResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetTimeseriesByClicksDeprecatedResponseBody]] = dataclasses.field(default=None)
