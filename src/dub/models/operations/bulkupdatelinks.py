...
class Data(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["url", "trackConversion", "archived", "publicStats", "tagId", "tagIds", "tagNames", "comments", "expiresAt", "expiredUrl", "password", "proxy", "title", "description", "image", "video", "rewrite", "ios", "android", "geo", "doIndex", "utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"]
        nullable_fields = ["tagId", "comments", "expiresAt", "expiredUrl", "password", "title", "description", "image", "video", "ios", "android", "geo", "utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"]
        null_default_fields = []
