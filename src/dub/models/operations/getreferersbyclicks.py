...
class GetReferersByClicksGlobals:
...
class GetReferersByClicksQueryParamInterval(str, Enum):
...
class GetReferersByClicksRequest:
    ...
    interval: Optional[GetReferersByClicksQueryParamInterval] = dataclasses.field(default=GetReferersByClicksQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetReferersByClicksResponseBody:
...
@dataclasses.dataclass
class GetReferersByClicksResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetReferersByClicksResponseBody]] = dataclasses.field(default=None)
