...
class GetTopLinksByClicksDeprecatedGlobals:
...
class GetTopLinksByClicksDeprecatedQueryParamInterval(str, Enum):
...
class GetTopLinksByClicksDeprecatedRequest:
    ...
    interval: Optional[GetTopLinksByClicksDeprecatedQueryParamInterval] = dataclasses.field(default=GetTopLinksByClicksDeprecatedQueryParamInterval.TWENTY_FOURH, metadata={'query_param': { 'field_name': 'interval', 'style': 'form', 'explode': True }})
    r"""The interval to retrieve analytics for. Takes precedence over start and end. If undefined, defaults to 24h."""
...
@dataclasses.dataclass
class GetTopLinksByClicksDeprecatedResponseBody:
...
@dataclasses.dataclass
class GetTopLinksByClicksDeprecatedResponse:
    http_meta: components_httpmetadata.HTTPMetadata = dataclasses.field()
    response_bodies: Optional[List[GetTopLinksByClicksDeprecatedResponseBody]] = dataclasses.field(default=None)
