...
class UnprocessableEntityError:
    code: UnprocessableEntityCode = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
    r"""A short code indicating the error code returned."""
...
class UnprocessableEntity(Exception):
    ...
    error: UnprocessableEntityError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
