...
class QRCodes:
    ...
    def get(self, request: operations.GetQRCodeRequest) -> operations.GetQRCodeResponse:
        r"""Retrieve a QR code
        Retrieve a QR code for a link.
        """
        hook_ctx = HookContext(operation_id='getQRCode', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetQRCodeResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
