...
class Workspaces(BaseSDK):
    ...
    def update(
        ...
        request = operations.UpdateWorkspaceRequest(
            ...
            request_body=utils.unmarshal(request_body, operations.UpdateWorkspaceRequestBody) if not isinstance(request_body, BaseModel) and request_body is not None else request_body,
        )
