...
class Workspaces(BaseSDK):
    ...
    def update(
        self, *,
        request: Union[operations.UpdateWorkspaceRequest, operations.UpdateWorkspaceRequestTypedDict],
        server_url: Optional[str] = None,
    ) -> components.WorkspaceSchema:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.UpdateWorkspaceRequest)
