...
class Links(BaseSDK):
    ...
    def update(
        ...
        request = operations.UpdateLinkRequest(
            link_id=link_id,
            request_body=utils.unmarshal(request_body, operations.UpdateLinkRequestBody) if not isinstance(request_body, BaseModel) and request_body is not None else request_body,
        )
