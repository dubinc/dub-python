...
class Payouts(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            operations.ListPayoutsRequest, operations.ListPayoutsRequestTypedDict
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListPayoutsRequest)
        request = cast(operations.ListPayoutsRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                List[operations.ListPayoutsResponseBody], http_res
            )
