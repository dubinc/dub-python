...
class DiscountCodes(BaseSDK):
    def list(
        self,
        *,
        request: Union[
            operations.ListDiscountCodesRequest,
            operations.ListDiscountCodesRequestTypedDict,
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListDiscountCodesRequest)
        request = cast(operations.ListDiscountCodesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="listDiscountCodes",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                List[components.DiscountCodeSchema], http_res
            )
    ...
    def create(
        ...
        *,
        request: Optional[
            Union[
                operations.CreateDiscountCodeRequestBody,
                operations.CreateDiscountCodeRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> components.DiscountCodeSchema:
        r"""Create a discount code
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[operations.CreateDiscountCodeRequestBody]
            )
        request = cast(Optional[operations.CreateDiscountCodeRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[operations.CreateDiscountCodeRequestBody],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="createDiscountCode",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
                tags=["Discount Codes"],
                extensions=None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(components.DiscountCodeSchema, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.BadRequestData, http_res)
            raise errors.BadRequest(response_data, http_res)
        if utils.match_response(http_res, "401", "application/json"):
    ...
    def delete(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.DeleteDiscountCodeResponseBody:
        r"""Delete a discount code
        ...
        :param id_or_code: The unique ID (e.g. `dcode_...`) or alphanumeric code (e.g. `ABC123`) of the discount code to delete.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="deleteDiscountCode",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
                tags=["Discount Codes"],
                extensions=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                operations.DeleteDiscountCodeResponseBody, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.BadRequestData, http_res)
            raise errors.BadRequest(response_data, http_res)
