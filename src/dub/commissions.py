...
class Commissions(BaseSDK):
    ...
    def create(
        ...
        *,
        request: Optional[
            Union[
                operations.CreateCommissionRequestBody,
                operations.CreateCommissionRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[operations.CreateCommissionRequestBody]
            )
        request = cast(Optional[operations.CreateCommissionRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[operations.CreateCommissionRequestBody],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return unmarshal_json_response(
                operations.CreateCommissionResponseBody, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(errors.BadRequestData, http_res)
            raise errors.BadRequest(response_data, http_res)
